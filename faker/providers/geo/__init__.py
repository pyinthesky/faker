...
class Provider(BaseProvider):
    ...
    land_coords: list[PlaceType] = [
        ## Represent all country codes
        ("-54.283333", "-36.500000", "King Edward Point", "GS", "Atlantic/South_Georgia"),
        ("-49.35", "70.216667", "Port-aux-Fran̤ais", "TF", "Indian/Kerguelen"),
        ("31.766666666666666", "35.233333", "Jerusalem", "PS", "Asia/Jerusalem"),
        ("60.116667", "19.900000", "Mariehamn", "AX", "Europe/Mariehamn"),
        ("-0.5477", "166.920867", "Yaren", "NR", "Pacific/Nauru"),
        ("18.0731", "-63.082200", "Marigot", "MF", "America/Marigot"),
        ("-9.166667", "-171.833333", "Atafu", "TK", "Pacific/Fakaofo"),
        ("27.153611", "-13.203333", "El-Aai̼n", "EH", "Africa/El_Aaiun"),
        ("34.516666666666666", "69.183333", "Kabul", "AF", "Asia/Kabul"),
        ("41.31666666666667", "19.816667", "Tirana", "AL", "Europe/Tirane"),
        ("36.75", "3.050000", "Algiers", "DZ", "Africa/Algiers"),
        ("-14.266666666666667", "-170.700000", "Pago Pago", "AS", "Pacific/Pago_Pago"),
        ("42.5", "1.516667", "Andorra la Vella", "AD", "Europe/Andorra"),
        ("-8.833333333333334", "13.216667", "Luanda", "AO", "Africa/Luanda"),
        ("18.216666666666665", "-63.050000", "The Valley", "AI", "America/Anguilla"),
        ("17.116666666666667", "-61.850000", "Saint John's", "AG", "America/Antigua"),
        ("-34.583333333333336", "-58.666667", "Buenos Aires", "AR", "America/Argentina/Buenos_Aires"),
        ("40.166666666666664", "44.500000", "Yerevan", "AM", "Asia/Yerevan"),
        ("12.516666666666667", "-70.033333", "Oranjestad", "AW", "America/Aruba"),
        ("-35.266666666666666", "149.133333", "Canberra", "AU", "Australia/Sydney"),
        ("48.2", "16.366667", "Vienna", "AT", "Europe/Vienna"),
        ("40.38333333333333", "49.866667", "Baku", "AZ", "Asia/Baku"),
        ("25.083333333333332", "-77.350000", "Nassau", "BS", "America/Nassau"),
        ("26.233333333333334", "50.566667", "Manama", "BH", "Asia/Bahrain"),
        ("23.716666666666665", "90.400000", "Dhaka", "BD", "Asia/Dhaka"),
        ("13.1", "-59.616667", "Bridgetown", "BB", "America/Barbados"),
        ("53.9", "27.566667", "Minsk", "BY", "Europe/Minsk"),
        ("50.833333333333336", "4.333333", "Brussels", "BE", "Europe/Brussels"),
        ("17.25", "-88.766667", "Belmopan", "BZ", "America/Belize"),
        ("6.483333333333333", "2.616667", "Porto-Novo", "BJ", "Africa/Porto-Novo"),
        ("32.28333333333333", "-64.783333", "Hamilton", "BM", "Atlantic/Bermuda"),
        ("27.466666666666665", "89.633333", "Thimphu", "BT", "Asia/Thimphu"),
        ("-16.5", "-68.150000", "La Paz", "BO", "America/La_Paz"),
        ("43.86666666666667", "18.416667", "Sarajevo", "BA", "Europe/Sarajevo"),
        ("-24.633333333333333", "25.900000", "Gaborone", "BW", "Africa/Gaborone"),
        ("-15.783333333333333", "-47.916667", "Brasilia", "BR", "America/Sao_Paulo"),
        ("18.416666666666668", "-64.616667", "Road Town", "VG", "America/Tortola"),
        ("4.883333333333333", "114.933333", "Bandar Seri Begawan", "BN", "Asia/Brunei"),
        ("42.68333333333333", "23.316667", "Sofia", "BG", "Europe/Sofia"),
        ("12.366666666666667", "-1.516667", "Ouagadougou", "BF", "Africa/Ouagadougou"),
        ("16.8", "96.150000", "Rangoon", "MM", "Asia/Yangon"),
        ("-3.3666666666666667", "29.350000", "Bujumbura", "BI", "Africa/Bujumbura"),
        ("11.55", "104.916667", "Phnom Penh", "KH", "Asia/Phnom_Penh"),
        ("3.8666666666666667", "11.516667", "Yaounde", "CM", "Africa/Douala"),
        ("45.416666666666664", "-75.700000", "Ottawa", "CA", "America/Toronto"),
        ("14.916666666666666", "-23.516667", "Praia", "CV", "Atlantic/Cape_Verde"),
        ("19.3", "-81.383333", "George Town", "KY", "America/Cayman"),
        ("4.366666666666666", "18.583333", "Bangui", "CF", "Africa/Bangui"),
        ("12.1", "15.033333", "N'Djamena", "TD", "Africa/Douala"),
        ("-33.45", "-70.666667", "Santiago", "CL", "America/Santiago"),
        ("39.916666666666664", "116.383333", "Beijing", "CN", "Asia/Shanghai"),
        ("-10.416666666666666", "105.716667", "The Settlement", "CX", "Indian/Christmas"),
        ("-12.166666666666666", "96.833333", "West Island", "CC", "Indian/Cocos"),
        ("4.6", "-74.083333", "Bogota", "CO", "America/Bogota"),
        ("-11.7", "43.233333", "Moroni", "KM", "Indian/Comoro"),
        ("-4.316666666666666", "15.300000", "Kinshasa", "CD", "Africa/Kinshasa"),
        ("-4.25", "15.283333", "Brazzaville", "CG", "Africa/Brazzaville"),
        ("-21.2", "-159.766667", "Avarua", "CK", "Pacific/Rarotonga"),
        ("9.933333333333334", "-84.083333", "San Jose", "CR", "America/Costa_Rica"),
        ("6.816666666666666", "-5.266667", "Yamoussoukro", "CI", "Africa/Abidjan"),
        ("45.8", "16.000000", "Zagreb", "HR", "Europe/Zagreb"),
        ("23.116666666666667", "-82.350000", "Havana", "CU", "America/Havana"),
        ("12.1", "-68.916667", "Willemstad", "CW", "America/Curacao"),
        ("35.166666666666664", "33.366667", "Nicosia", "CY", "Asia/Nicosia"),
        ("50.083333333333336", "14.466667", "Prague", "CZ", "Europe/Prague"),
        ("55.666666666666664", "12.583333", "Copenhagen", "DK", "Europe/Copenhagen"),
        ("11.583333333333334", "43.150000", "Djibouti", "DJ", "Africa/Djibouti"),
        ("15.3", "-61.400000", "Roseau", "DM", "America/Dominica"),
        ("18.466666666666665", "-69.900000", "Santo Domingo", "DO", "America/Santo_Domingo"),
        ("-0.21666666666666667", "-78.500000", "Quito", "EC", "America/Guayaquil"),
        ("30.05", "31.250000", "Cairo", "EG", "Africa/Cairo"),
        ("13.7", "-89.200000", "San Salvador", "SV", "America/El_Salvador"),
        ("3.75", "8.783333", "Malabo", "GQ", "Africa/Malabo"),
        ("15.333333333333334", "38.933333", "Asmara", "ER", "Africa/Asmara"),
        ("59.43333333333333", "24.716667", "Tallinn", "EE", "Europe/Tallinn"),
        ("9.033333333333333", "38.700000", "Addis Ababa", "ET", "Africa/Addis_Ababa"),
        ("-51.7", "-57.850000", "Stanley", "FK", "Atlantic/Stanley"),
        ("62", "-6.766667", "Torshavn", "FO", "Atlantic/Faroe"),
        ("-18.133333333333333", "178.416667", "Suva", "FJ", "Pacific/Fiji"),
        ("60.166666666666664", "24.933333", "Helsinki", "FI", "Europe/Helsinki"),
        ("48.86666666666667", "2.333333", "Paris", "FR", "Europe/Paris"),
        ("-17.533333333333335", "-149.566667", "Papeete", "PF", "Pacific/Tahiti"),
        ("0.38333333333333336", "9.450000", "Libreville", "GA", "Africa/Libreville"),
        ("13.45", "-16.566667", "Banjul", "GM", "Africa/Banjul"),
        ("41.68333333333333", "44.833333", "Tbilisi", "GE", "Asia/Tbilisi"),
        ("52.516666666666666", "13.400000", "Berlin", "DE", "Europe/Berlin"),
        ("5.55", "-0.216667", "Accra", "GH", "Africa/Accra"),
        ("36.13333333333333", "-5.350000", "Gibraltar", "GI", "Europe/Gibraltar"),
        ("37.983333333333334", "23.733333", "Athens", "GR", "Europe/Athens"),
        ("64.18333333333334", "-51.750000", "Nuuk", "GL", "America/Nuuk"),
        ("12.05", "-61.750000", "Saint George's", "GD", "America/Grenada"),
        ("13.466666666666667", "144.733333", "Hagatna", "GU", "Pacific/Guam"),
        ("14.616666666666667", "-90.516667", "Guatemala City", "GT", "America/Guatemala"),
        ("49.45", "-2.533333", "Saint Peter Port", "GG", "Europe/Guernsey"),
        ("9.5", "-13.700000", "Conakry", "GN", "Africa/Conakry"),
        ("11.85", "-15.583333", "Bissau", "GW", "Africa/Bissau"),
        ("6.8", "-58.150000", "Georgetown", "GY", "America/Guyana"),
        ("18.533333333333335", "-72.333333", "Port-au-Prince", "HT", "America/Port-au-Prince"),
        ("41.9", "12.450000", "Vatican City", "VA", "Europe/Rome"),
        ("14.1", "-87.216667", "Tegucigalpa", "HN", "America/Tegucigalpa"),
        ("47.5", "19.083333", "Budapest", "HU", "Europe/Budapest"),
        ("64.15", "-21.950000", "Reykjavik", "IS", "Atlantic/Reykjavik"),
        ("28.6", "77.200000", "New Delhi", "IN", "Asia/Kolkata"),
        ("-6.166666666666667", "106.816667", "Jakarta", "ID", "Asia/Jakarta"),
        ("35.7", "51.416667", "Tehran", "IR", "Asia/Tehran"),
        ("33.333333333333336", "44.400000", "Baghdad", "IQ", "Asia/Baghdad"),
        ("53.31666666666667", "-6.233333", "Dublin", "IE", "Europe/Dublin"),
        ("54.15", "-4.483333", "Douglas", "IM", "Europe/Isle_of_Man"),
        ("31.766666666666666", "35.233333", "Jerusalem", "IL", "Asia/Jerusalem"),
        ("41.9", "12.483333", "Rome", "IT", "Europe/Rome"),
        ("18", "-76.800000", "Kingston", "JM", "America/Jamaica"),
        ("35.68333333333333", "139.750000", "Tokyo", "JP", "Asia/Tokyo"),
        ("49.18333333333333", "-2.100000", "Saint Helier", "JE", "Europe/Jersey"),
        ("31.95", "35.933333", "Amman", "JO", "Asia/Amman"),
        ("51.166666666666664", "71.416667", "Astana", "KZ", "Asia/Almaty"),
        ("-1.2833333333333332", "36.816667", "Nairobi", "KE", "Africa/Nairobi"),
        ("-0.8833333333333333", "169.533333", "Tarawa", "KI", "Pacific/Tarawa"),
        ("39.016666666666666", "125.750000", "Pyongyang", "KP", "Asia/Pyongyang"),
        ("37.55", "126.983333", "Seoul", "KR", "Asia/Seoul"),
        ("42.666666666666664", "21.166667", "Pristina", "KO", "Europe/Belgrade"),
        ("29.366666666666667", "47.966667", "Kuwait City", "KW", "Asia/Kuwait"),
        ("42.86666666666667", "74.600000", "Bishkek", "KG", "Asia/Bishkek"),
        ("17.966666666666665", "102.600000", "Vientiane", "LA", "Asia/Vientiane"),
        ("56.95", "24.100000", "Riga", "LV", "Europe/Riga"),
        ("33.86666666666667", "35.500000", "Beirut", "LB", "Asia/Beirut"),
        ("-29.316666666666666", "27.483333", "Maseru", "LS", "Africa/Maseru"),
        ("6.3", "-10.800000", "Monrovia", "LR", "Africa/Monrovia"),
        ("32.88333333333333", "13.166667", "Tripoli", "LY", "Africa/Tripoli"),
        ("47.13333333333333", "9.516667", "Vaduz", "LI", "Europe/Vaduz"),
        ("54.68333333333333", "25.316667", "Vilnius", "LT", "Europe/Vilnius"),
        ("49.6", "6.116667", "Luxembourg", "LU", "Europe/Luxembourg"),
        ("42", "21.433333", "Skopje", "MK", "Europe/Skopje"),
        ("-18.916666666666668", "47.516667", "Antananarivo", "MG", "Indian/Antananarivo"),
        ("-13.966666666666667", "33.783333", "Lilongwe", "MW", "Africa/Blantyre"),
        ("3.1666666666666665", "101.700000", "Kuala Lumpur", "MY", "Asia/Kuala_Lumpur"),
        ("4.166666666666667", "73.500000", "Male", "MV", "Indian/Maldives"),
        ("12.65", "-8.000000", "Bamako", "ML", "Africa/Bamako"),
        ("35.88333333333333", "14.500000", "Valletta", "MT", "Europe/Malta"),
        ("7.1", "171.383333", "Majuro", "MH", "Pacific/Majuro"),
        ("18.066666666666666", "-15.966667", "Nouakchott", "MR", "Africa/Nouakchott"),
        ("-20.15", "57.483333", "Port Louis", "MU", "Indian/Mauritius"),
        ("19.433333333333334", "-99.133333", "Mexico City", "MX", "America/Mexico_City"),
        ("6.916666666666667", "158.150000", "Palikir", "FM", "Pacific/Pohnpei"),
        ("47", "28.850000", "Chisinau", "MD", "Europe/Chisinau"),
        ("43.733333333333334", "7.416667", "Monaco", "MC", "Europe/Monaco"),
        ("47.916666666666664", "106.916667", "Ulaanbaatar", "MN", "Asia/Ulaanbaatar"),
        ("42.43333333333333", "19.266667", "Podgorica", "ME", "Europe/Podgorica"),
        ("16.7", "-62.216667", "Plymouth", "MS", "America/Montserrat"),
        ("34.016666666666666", "-6.816667", "Rabat", "MA", "Africa/Casablanca"),
        ("-25.95", "32.583333", "Maputo", "MZ", "Africa/Maputo"),
        ("-22.566666666666666", "17.083333", "Windhoek", "NA", "Africa/Windhoek"),
        ("27.716666666666665", "85.316667", "Kathmandu", "NP", "Asia/Kathmandu"),
        ("52.35", "4.916667", "Amsterdam", "NL", "Europe/Amsterdam"),
        ("-22.266666666666666", "166.450000", "Noumea", "NC", "Pacific/Noumea"),
        ("-41.3", "174.783333", "Wellington", "NZ", "Pacific/Auckland"),
        ("12.133333333333333", "-86.250000", "Managua", "NI", "America/Managua"),
        ("13.516666666666667", "2.116667", "Niamey", "NE", "Africa/Niamey"),
        ("9.083333333333334", "7.533333", "Abuja", "NG", "Africa/Lagos"),
        ("-19.016666666666666", "-169.916667", "Alofi", "NU", "Pacific/Niue"),
        ("-29.05", "167.966667", "Kingston", "NF", "Pacific/Norfolk"),
        ("15.2", "145.750000", "Saipan", "MP", "Pacific/Saipan"),
        ("59.916666666666664", "10.750000", "Oslo", "NO", "Europe/Oslo"),
        ("23.616666666666667", "58.583333", "Muscat", "OM", "Asia/Muscat"),
        ("33.68333333333333", "73.050000", "Islamabad", "PK", "Asia/Karachi"),
        ("7.483333333333333", "134.633333", "Melekeok", "PW", "Pacific/Palau"),
        ("8.966666666666667", "-79.533333", "Panama City", "PA", "America/Panama"),
        ("-9.45", "147.183333", "Port Moresby", "PG", "Pacific/Port_Moresby"),
        ("-25.266666666666666", "-57.666667", "Asuncion", "PY", "America/Asuncion"),
        ("-12.05", "-77.050000", "Lima", "PE", "America/Lima"),
        ("14.6", "120.966667", "Manila", "PH", "Asia/Manila"),
        ("-25.066666666666666", "-130.083333", "Adamstown", "PN", "Pacific/Pitcairn"),
        ("52.25", "21.000000", "Warsaw", "PL", "Europe/Warsaw"),
        ("38.71666666666667", "-9.133333", "Lisbon", "PT", "Europe/Lisbon"),
        ("18.466666666666665", "-66.116667", "San Juan", "PR", "America/Puerto_Rico"),
        ("25.283333333333335", "51.533333", "Doha", "QA", "Asia/Qatar"),
        ("44.43333333333333", "26.100000", "Bucharest", "RO", "Europe/Bucharest"),
        ("55.75", "37.600000", "Moscow", "RU", "Europe/Moscow"),
        ("-1.95", "30.050000", "Kigali", "RW", "Africa/Kigali"),
        ("17.883333333333333", "-62.850000", "Gustavia", "BL", "America/St_Barthelemy"),
        ("-15.933333333333334", "-5.716667", "Jamestown", "SH", "Atlantic/St_Helena"),
        ("17.3", "-62.716667", "Basseterre", "KN", "America/St_Kitts"),
        ("14", "-61.000000", "Castries", "LC", "America/St_Lucia"),
        ("46.766666666666666", "-56.183333", "Saint-Pierre", "PM", "America/Miquelon"),
        ("13.133333333333333", "-61.216667", "Kingstown", "VC", "America/St_Vincent"),
        ("-13.816666666666666", "-171.766667", "Apia", "WS", "Pacific/Apia"),
        ("43.93333333333333", "12.416667", "San Marino", "SM", "Europe/San_Marino"),
        ("0.3333333333333333", "6.733333", "Sao Tome", "ST", "Africa/Sao_Tome"),
        ("24.65", "46.700000", "Riyadh", "SA", "Asia/Riyadh"),
        ("14.733333333333333", "-17.633333", "Dakar", "SN", "Africa/Dakar"),
        ("44.833333333333336", "20.500000", "Belgrade", "RS", "Europe/Belgrade"),
        ("-4.616666666666667", "55.450000", "Victoria", "SC", "Indian/Mahe"),
        ("8.483333333333333", "-13.233333", "Freetown", "SL", "Africa/Freetown"),
        ("1.2833333333333332", "103.850000", "Singapore", "SG", "Asia/Singapore"),
        ("18.016666666666666", "-63.033333", "Philipsburg", "SX", "America/Lower_Princes"),
        ("48.15", "17.116667", "Bratislava", "SK", "Europe/Bratislava"),
        ("46.05", "14.516667", "Ljubljana", "SI", "Europe/Ljubljana"),
        ("-9.433333333333334", "159.950000", "Honiara", "SB", "Pacific/Guadalcanal"),
        ("2.066666666666667", "45.333333", "Mogadishu", "SO", "Africa/Mogadishu"),
        ("-25.7", "28.216667", "Pretoria", "ZA", "Africa/Johannesburg"),
        ("4.85", "31.616667", "Juba", "SS", "Africa/Juba"),
        ("40.4", "-3.683333", "Madrid", "ES", "Europe/Madrid"),
        ("6.916666666666667", "79.833333", "Colombo", "LK", "Asia/Colombo"),
        ("15.6", "32.533333", "Khartoum", "SD", "Africa/Khartoum"),
        ("5.833333333333333", "-55.166667", "Paramaribo", "SR", "America/Paramaribo"),
        ("78.21666666666667", "15.633333", "Longyearbyen", "SJ", "Arctic/Longyearbyen"),
        ("-26.316666666666666", "31.133333", "Mbabane", "SZ", "Africa/Mbabane"),
        ("59.333333333333336", "18.050000", "Stockholm", "SE", "Europe/Stockholm"),
        ("46.916666666666664", "7.466667", "Bern", "CH", "Europe/Zurich"),
        ("33.5", "36.300000", "Damascus", "SY", "Asia/Damascus"),
        ("25.033333333333335", "121.516667", "Taipei", "TW", "Asia/Taipei"),
        ("38.55", "68.766667", "Dushanbe", "TJ", "Asia/Dushanbe"),
        ("-6.8", "39.283333", "Dar es Salaam", "TZ", "Africa/Dar_es_Salaam"),
        ("13.75", "100.516667", "Bangkok", "TH", "Asia/Bangkok"),
        ("-8.583333333333334", "125.600000", "Dili", "TL", "Asia/Dili"),
        ("6.116666666666666", "1.216667", "Lome", "TG", "Africa/Lome"),
        ("-21.133333333333333", "-175.200000", "Nuku'alofa", "TO", "Pacific/Tongatapu"),
        ("10.65", "-61.516667", "Port of Spain", "TT", "America/Port_of_Spain"),
        ("36.8", "10.183333", "Tunis", "TN", "Africa/Tunis"),
        ("39.93333333333333", "32.866667", "Ankara", "TR", "Europe/Istanbul"),
        ("37.95", "58.383333", "Ashgabat", "TM", "Asia/Ashgabat"),
        ("21.466666666666665", "-71.133333", "Grand Turk", "TC", "America/Grand_Turk"),
        ("-8.516666666666667", "179.216667", "Funafuti", "TV", "Pacific/Funafuti"),
        ("0.31666666666666665", "32.550000", "Kampala", "UG", "Africa/Kampala"),
        ("50.43333333333333", "30.516667", "Kyiv", "UA", "Europe/Kyiv"),
        ("24.466666666666665", "54.366667", "Abu Dhabi", "AE", "Asia/Dubai"),
        ("51.5", "-0.083333", "London", "GB", "Europe/London"),
        ("38.883333", "-77.000000", "Washington D.C.", "US", "America/New_York"),
        ("-34.85", "-56.166667", "Montevideo", "UY", "America/Montevideo"),
        ("41.31666666666667", "69.250000", "Tashkent", "UZ", "Asia/Tashkent"),
        ("-17.733333333333334", "168.316667", "Port-Vila", "VU", "Pacific/Efate"),
        ("10.483333333333333", "-66.866667", "Caracas", "VE", "America/Caracas"),
        ("21.033333333333335", "105.850000", "Hanoi", "VN", "Asia/Bangkok"),
        ("18.35", "-64.933333", "Charlotte Amalie", "VI", "America/St_Thomas"),
        ("-13.95", "-171.933333", "Mata-Utu", "WF", "Pacific/Apia"),
        ("15.35", "44.200000", "Sanaa", "YE", "Asia/Aden"),
        ("-15.416666666666666", "28.283333", "Lusaka", "ZM", "Africa/Lusaka"),
        ("-17.816666666666666", "31.033333", "Harare", "ZW", "Africa/Harare"),
        ("19.282319", "166.647047", "Washington D.C.", "UM", "Pacific/Wake"),
        ("-75.250973", "-0.071389", "Antarctica", "AQ", "Africa/Johannesburg"),
        ("22.302711", "114.177216", "Hong Kong", "HK", "Asia/Hong_Kong"),
        ("53.0818", "73.5042", "Heard Island and McDonald Islands", "HM", "Asia/Almaty"),
        ("-7.3", "72.400000", "Diego Garcia", "IO", "Indian/Chagos"),
        ("22.210928", "113.552971", "Macau", "MO", "Asia/Macau"),
        ("12.1783611", "-68.2385339", "Caribbean Netherlands", "BQ", "America/Kralendijk"),
        ## END
